...
namespace VfxEditor.Utils {
    ...
    public static class UiUtils {
        ...
        private delegate bool DrawRadiansInputDelegate<T>( ImU8String label, scoped ref T value );

        public static bool DrawRadians( string name, float oldValue, out float newValue ) => DrawRadians( name, oldValue, out newValue, ToDegrees, ToRadians, ( ImU8String label, scoped ref float val )
    => ImGui.InputFloat( label, ref val, 0.0f, 0.0f, default, ImGuiInputTextFlags.None ) );

        public static bool DrawRadians3( string name, Vector3 oldValue, out Vector3 newValue ) => DrawRadians( name, oldValue, out newValue, ToDegrees, ToRadians, ( ImU8String label, scoped ref Vector3 val )
    => ImGui.InputFloat3( label, ref val, 0.0f, 0.0f, default, ImGuiInputTextFlags.None ) );

        public static bool DrawRadians4( string name, Vector4 oldValue, out Vector4 newValue ) => DrawRadians( name, oldValue, out newValue, ToDegrees, ToRadians, ( ImU8String label, scoped ref Vector4 val )
    => ImGui.InputFloat4( label, ref val, 0.0f, 0.0f, default, ImGuiInputTextFlags.None ) );
        ...
        public static bool DrawDragDrop<T>( List<T> items, T item, string text, ref T draggingItem, string id, bool record ) where T : class {
            ...
            if( ImGui.BeginDragDropSource( ImGuiDragDropFlags.None ) ) {
                ImGui.SetDragDropPayload( id, ReadOnlySpan<byte>.Empty, 0 );
                draggingItem = item;
                ImGui.Text( text );
